...
(function ($) {
    $.extend({
        ...
        operate: {
            ...
            //核算数据
            mzaccounting: function(){
            	$.modal.confirm("确定核算该月数据" + $.table._option.modalName + "吗？", function() {
	            	var url = $.table._option.mzaccountingUrl;
            ...
            // 导入信息
            importexcel: function(id) {
            	var url = $.common.isEmpty(id) ? $.table._option.importUrl : $.table._option.importUrl.replace("{id}", id);
